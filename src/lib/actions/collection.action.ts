...
export async function toggleSaveQuestion(
    ...
    try {
        const question = await Collection.findById(questionId);
...
export async function getSavedQuestions(params: PaginatedSearchParams): Promise<ActionResponse<{ collection: GCollection[], isNext: boolean }>> {
    const validationResult = await action({
        params,
