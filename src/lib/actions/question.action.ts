...
import { ActionResponse, ErrorResponse, GQuestion } from "@/types/global";
...
export async function createQuestion(params: CreateQuestionParams): Promise<ActionResponse<GQuestion>> {
...
export async function editQuestion(params: EditQuestionParams): Promise<ActionResponse<GQuestion>> {
    const validationResult = await action({
        params,
