...
import { AskQuestionSchema, EditQuestionSchema, PaginatedSearchParamsSchema } from "../validation";
...
): Promise<ActionResponse<GQuestion>> {
...
) : Promise<ActionResponse<{ questions: GQuestion[]; isNext: boolean }>> {
    const validationResult = await action({
        params,
